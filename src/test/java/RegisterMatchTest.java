...
public class RegisterMatchTest {
    ...
    @Test
    public void test_Register_HomeTeamNotFilledIn_ErrorMessageForHomeTeam_OtherFieldsStayFilled() {
        IndexPage index = PageFactory.initElements(driver, IndexPage.class);
        index.login();
        RegisterMatchPage registerMatchPage = PageFactory.initElements(driver, RegisterMatchPage.class);
        registerMatchPage.setHome("");
        registerMatchPage.setAway("Dojo Test");
        registerMatchPage.setDate("05052025");
        registerMatchPage.setTime("1500PM");
        registerMatchPage.register();
        ...
        assertTrue(registerMatchPage.hasErrorMessage("No home club given"));
        assertTrue(registerMatchPage.hasEmptyHome());
        assertTrue(registerMatchPage.hasStickyAway("Dojo Test"));
        assertTrue(registerMatchPage.hasStickyDate("2025-05-05"));
        assertTrue(registerMatchPage.hasStickyTime("15:00"));
    }

    @Test
    public void test_Register_AwayTeamNotFilledIn_ErrorMessageForAwayTeam_OtherFieldsStayFilled() {
        IndexPage index = PageFactory.initElements(driver, IndexPage.class);
        index.login();
        RegisterMatchPage registerMatchPage = PageFactory.initElements(driver, RegisterMatchPage.class);
        registerMatchPage.setHome("Dojo Kamiyama");
        registerMatchPage.setAway("");
        registerMatchPage.setDate("05052025");
        registerMatchPage.setTime("1500PM");
        registerMatchPage.register();
        ...
        assertTrue(registerMatchPage.hasErrorMessage("No away club given"));
        assertTrue(registerMatchPage.hasStickyHome("Dojo Kamiyama"));
        assertTrue(registerMatchPage.hasEmptyAway());
        assertTrue(registerMatchPage.hasStickyDate("2025-05-05"));
        assertTrue(registerMatchPage.hasStickyTime("15:00"));
    }

    @Test
    public void test_Register_DateTeamNotFilledIn_ErrorMessageForDate_OtherFieldsStayFilled() {
        IndexPage index = PageFactory.initElements(driver, IndexPage.class);
        index.login();
        RegisterMatchPage registerMatchPage = PageFactory.initElements(driver, RegisterMatchPage.class);
        registerMatchPage.setHome("Dojo Kamiyama");
        registerMatchPage.setAway("Dojo Test");
        registerMatchPage.setDate("");
        registerMatchPage.setTime("1500PM");
        registerMatchPage.register();

        assertEquals("Add Match", registerMatchPage.getTitle());

        assertTrue(registerMatchPage.hasErrorMessage("No date given"));
        assertTrue(registerMatchPage.hasStickyHome("Dojo Kamiyama"));
        assertTrue(registerMatchPage.hasStickyAway("Dojo Test"));
        assertTrue(registerMatchPage.hasEmptyDate());
        assertTrue(registerMatchPage.hasStickyTime("15:00"));
    }
